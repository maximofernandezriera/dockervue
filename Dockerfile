...
# docker build -t maxfernandez/docker-vuejs-app .
# Subirla:
# docker push maxfernandez/docker-vuejs-app
# Ejecutarla: 
# docker run -it -p 8080:8080 --rm --name docker-vuejs-app-1 maxfernandez/docker-vuejs-app
